#ifndef MYROTATEPICTURES_H
#define MYROTATEPICTURES_H
...
namespace Ui {
class myRotatePictures;
}

class myRotatePictures : public QWidget
{
    Q_OBJECT

public:
    explicit myRotatePictures(QWidget *parent = nullptr);
    ~myRotatePictures();
// 设置图片列表;
...
private:
    Ui::myRotatePictures *ui;
};

#endif // MYROTATEPICTURES_H
